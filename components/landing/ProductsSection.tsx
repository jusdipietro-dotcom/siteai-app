...
const products = [
  ...
  },
  {
    ...
    description: 'Bot de señales crypto con 60% win rate verificado (backtest 6 meses). Analiza 18 pares seleccionados con 7 indicadores técnicos (RSI, MACD, EMA, Bollinger, ADX, Volumen, Patrones de Velas) + 3 indicadores macro (Fear & Greed, Funding Rate, BTC Dominance). Alertas de compra y venta en tu Telegram con Stop Loss y Take Profit automáticos.',
    icon: TrendingUp,
    gradient: 'from-amber-500 to-orange-500',
    bgGlow: 'bg-amber-500/10',
    features: [
      { icon: Activity, text: '60% win rate verificado — 18 pares seleccionados 24/7' },
      { icon: Shield, text: '7 indicadores técnicos + 3 macro (Fear & Greed, Funding, BTC Dom)' },
      { icon: MessageSquare, text: 'Alertas en Telegram con SL/TP automáticos y score de confianza' },
    ],
